<template>
  <div
    class="bg-white shadow-md top-0 left-0 w-full z-20 h-20 flex items-center"
  >
    <div
    ...
    >
      <div>
        <a href="/">
          <img :src="logo_header" alt="Vietmerce Logo" class="h-14" />
        </a>
      </div>
      ...
      <nav class="hidden md:flex space-x-8 text-lg">
        ...
        <a
          ...
          class="hover:underline"
          :class="{
            'font-bold text-orange-600  ': isActive('/about'),
          }"
          >ABOUT</a
        >
        <a
          ...
          class="hover:underline"
          :class="{
            'font-bold text-orange-600  ': isActive('/service'),
          }"
          >SERVICE</a
        >
        <a
          ...
          class="hover:underline"
          :class="{
            'font-bold text-orange-600  ': isActive('/contact'),
          }"
          >CONTACT</a
        >
      </nav>
...
<script setup>
import { ref } from "vue";
import logo_header from "../assets/img/logo/logo-vietmerce.png";
